import { Feather, Package, Footprints } from 'lucide-react';
...
const products = [
    ...
    { id: 4, name: 'Court Shoes', price: 89.99, description: 'Lightweight and comfortable court shoes', icon: <Footprints /> },
